...
<body>
        ...
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><svg class="MRTN__sc-11duill-7 eiZuJc" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="309" height="48" viewBox="0 0 309 48">
                    <defs>
                        ...
                        <path fill="#FE6F5F" d="M38.853 21.69v11.068a1.747 1.747 0 1 0 3.493 0V21.69a1.747 1.747 0 1 0-3.493 0"></path>
                    </g>
                </svg></a>
    ...
    <ul class="list-group">
        <?php $accueil = new AccueilController();
        foreach ($accueil as $accueils) : ?>

            <li class="list-group-item"><?php $accueil->getname() ?> ></li>
